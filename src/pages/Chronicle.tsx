  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8 max-w-2xl">
        ...
        <blockquote className="text-sm italic text-muted-foreground border-l-2 border-foreground/20 pl-4 mb-8">
          ...
          <footer className="mt-1 text-xs text-foreground font-display tracking-wider not-italic">— The Chronicler</footer>
        </blockquote>
