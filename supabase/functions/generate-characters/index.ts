...
Generate exactly 10 unique character profiles. Each must have:
...
Distribute factions roughly evenly (2-3 per faction). Make each character feel distinct in personality and origin.`;
      ...
      "https://ai.gateway.lovable.dev/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            ...
            { role: "user", content: "Generate the 10 character profiles now." },
          ],
          tools: [
            {
              type: "function",
              function: {
                ...
                description: "Return 10 character profiles for new players.",
                parameters: {
                  type: "object",
                  properties: {
                    characters: {
